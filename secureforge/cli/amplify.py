...
from secureforge.cli.common import is_data_record, normalize_record_samples
from secureforge.cli.utils import LOG_FORMAT, configure_logging, get_model_config
...
def process_scenario_worker(
    ...
    from secureforge.kernels import LMRephrasingKernel
    from secureforge.uncertainty import mcmc, rephrase_baseline
    from secureforge.constants import create_lm
    from secureforge.analyzers.common import AnalysisTool as AT
...
def amplify(
    ...
    """
    from secureforge.config import AmplifyConfig
