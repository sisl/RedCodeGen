...
from secureforge.config import OptimizeConfig
...
from secureforge.optimize import OptimizeMethods
...
def optimize(
    ...
    run_name: str = typer.Option("sf_run", "--run-name", help="[sft/contrastive] Experiment run name"),
    project: str = typer.Option("secureforge", "--project", help="[sft/contrastive] W&B project name"),
...
def _run_prompt_optimization(
    ...
    from secureforge.optimize import optimize as run_optimize
    from secureforge.generator.prompting import GenerateCode
...
def _run_training(
    ...
    if method == OptimizeMethods.SFT:
        from secureforge.optimize import run_sft
        ...
        from secureforge.optimize import run_contrastive
...
def _run_training_tk(
    ...
    if method == OptimizeMethods.SFT_TK:
        from secureforge.optimize import run_sft_tk
        ...
        from secureforge.optimize import run_contrastive_tk
